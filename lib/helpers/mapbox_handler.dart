...
import 'package:ultron_5/requests/nearby_places.dart';
...
//--------------------------------Nearby Places----------------------------------
Future<List> getParsedResponseForHomePage(String value) async {
  List parsedResponses = [];
  ...
  // Else search and then send response
  var response = json.decode(await getNearbyPlacesUsingMapbox(query));
